...
public abstract class Metadata {
    ...
    public static Metadata lcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class GeneralMetadata extends Metadata {
        public final org.diem.types.GeneralMetadata value;

        public GeneralMetadata(org.diem.types.GeneralMetadata value) {
        ...
        static GeneralMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.diem.types.GeneralMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.diem.types.GeneralMetadata value;
    ...
    public static final class TravelRuleMetadata extends Metadata {
        public final org.diem.types.TravelRuleMetadata value;

        public TravelRuleMetadata(org.diem.types.TravelRuleMetadata value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static TravelRuleMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.diem.types.TravelRuleMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.diem.types.TravelRuleMetadata value;
    ...
    public static final class UnstructuredBytesMetadata extends Metadata {
        public final org.diem.types.UnstructuredBytesMetadata value;

        public UnstructuredBytesMetadata(org.diem.types.UnstructuredBytesMetadata value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static UnstructuredBytesMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.diem.types.UnstructuredBytesMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.diem.types.UnstructuredBytesMetadata value;
