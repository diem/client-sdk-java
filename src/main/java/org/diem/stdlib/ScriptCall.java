...
public abstract class ScriptCall {
     ...
     * send, receive, and hold {@code Libra::Libra<Currency>} coins. This transaction can be
     ...
     * {@code LibraAccount::Balance<Currency>} resource with zero balance published under it. Only
     * accounts that can hold balances can send this transaction, the sending account cannot
     * already have a {@code LibraAccount::Balance<Currency>} published under it.
     *
     * <p><b>Parameters</b>
     ...
     * | {@code Errors::INVALID_ARGUMENT}  | {@code LibraAccount::EROLE_CANT_STORE_BALANCE} | The sending {@code account}'s role does not permit balances.                     |
     * | {@code Errors::ALREADY_PUBLISHED} | {@code LibraAccount::EADD_EXISTING_CURRENCY}   | A balance for {@code Currency} is already published under the sending {@code account}. |
     *
     ...
     *
     * <p><b>Technical Description</b>
     * Adds the {@code LibraAccount::KeyRotationCapability} for the sending account
     ...
     * | {@code recovery_address}   | {@code address} | The account address where the {@code to_recover_account}'s {@code LibraAccount::KeyRotationCapability} will be stored. |
     *
     * <p><b>Common Abort Conditions</b>
     * | Error Category             | Error Reason                                               | Description                                                                                     |
     * | ----------------           | --------------                                             | -------------                                                                                   |
     * | {@code Errors::INVALID_STATE}    | {@code LibraAccount::EKEY_ROTATION_CAPABILITY_ALREADY_EXTRACTED} | {@code to_recover_account} has already delegated/extracted its {@code LibraAccount::KeyRotationCapability}. |
     ...
     * <p><b>Technical Description</b>
     *
     * The sending account ({@code lr_account}) must be the Libra Root account. The script allow
     ...
     * {@code LibraTransactionPublishingOption::LibraTransactionPublishingOption}'s
     ...
     * | Name            | Type         | Description                                                                                     |
     * | ------          | ------       | -------------                                                                                   |
     * | {@code lr_account}    | {@code &signer}    | The signer reference of the sending account of this transaction. Must be the Libra Root signer. |
     ...
     * This transaction emits a {@code LibraConfig::NewEpochEvent} event and triggers a
    ...
    public static final class AddValidatorAndReconfigure extends ScriptCall {
        ...
        public AddValidatorAndReconfigure(@com.novi.serde.Unsigned Long sliding_nonce, com.novi.serde.Bytes validator_name, AccountAddress validator_address) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
     ...
     * stored in the {@code Libra::Preburn<Token>} resource published under the
     * {@code preburn_address} account address.
     *
     * This transaction will only succeed if the sending {@code account} has a
     * {@code Libra::BurnCapability<Token>}, and a {@code Libra::Preburn<Token>} resource
     ...
     * {@code Libra::CurrencyInfo<Token>} resource published under {@code 0xA550C18} will be
     ...
     *
     * <p><b>Events</b>
     * The successful execution of this transaction will emit a {@code Libra::BurnEvent} on the event handle
     * held in the {@code Libra::CurrencyInfo<Token>} resource's {@code burn_events} published under
     * {@code 0xA550C18}.
     *
     * <p><b>Parameters</b>
     * | Name              | Type      | Description                                                                                                                  |
     ...
     * | {@code Errors::INVALID_ARGUMENT}    | {@code SlidingNonce::ENONCE_TOO_NEW}          | The {@code sliding_nonce} is too far in the future.                                                         |
     * | {@code Errors::INVALID_ARGUMENT}    | {@code SlidingNonce::ENONCE_ALREADY_RECORDED} | The {@code sliding_nonce} has been previously recorded.                                                     |
     * | {@code Errors::REQUIRES_CAPABILITY} | {@code Libra::EBURN_CAPABILITY}               | The sending {@code account} does not have a {@code Libra::BurnCapability<Token>} published under it.              |
     * | {@code Errors::NOT_PUBLISHED}       | {@code Libra::EPREBURN}                       | The account at {@code preburn_address} does not have a {@code Libra::Preburn<Token>} resource published under it. |
     * | {@code Errors::INVALID_STATE}       | {@code Libra::EPREBURN_EMPTY}                 | The {@code Libra::Preburn<Token>} resource is empty (has a value of 0).                                     |
    ...
    public static final class Burn extends ScriptCall {
        ...
        public Burn(TypeTag token, @com.novi.serde.Unsigned Long sliding_nonce, AccountAddress preburn_address) {
     ...
     * <p><b>Events</b>
     * The successful execution of this transaction will emit a {@code Libra::BurnEvent} on the event handle
     * held in the {@code Libra::CurrencyInfo<CoinType>} resource's {@code burn_events} published under
     * {@code 0xA550C18}.
     *
     * <p><b>Parameters</b>
     * | Name         | Type      | Description                                                                                                                                         |
     ...
     * | {@code Errors::INVALID_ARGUMENT} | {@code Libra::ECOIN}                        | The collected fees in {@code CoinType} are zero.                  |
     *
     * <p><b>Related Scripts</b>
     ...
     *
     * <p><b>Technical Description</b>
     * Cancels and returns all coins held in the {@code Libra::Preburn<Token>} resource under the {@code preburn_address} and
     * return the funds to the {@code preburn_address} account's {@code LibraAccount::Balance<Token>}.
     * The transaction must be sent by an {@code account} with a {@code Libra::BurnCapability<Token>}
     * resource published under it. The account at {@code preburn_address} must have a
     * {@code Libra::Preburn<Token>} resource published under it, and its value must be nonzero. The transaction removes
     * the entire balance held in the {@code Libra::Preburn<Token>} resource, and returns it back to the account's
     * {@code LibraAccount::Balance<Token>} under {@code preburn_address}. Due to this, the account at
     ...
     * <ul><li>A {@code Libra::CancelBurnEvent} on the event handle held in the {@code Libra::CurrencyInfo<Token>}</li></ul>
     * resource's {@code burn_events} published under {@code 0xA550C18}.
     * <ul><li>A {@code LibraAccount::ReceivedPaymentEvent} on the {@code preburn_address}'s</li></ul>
     * {@code LibraAccount::LibraAccount} {@code received_events} event handle with both the {@code payer} and {@code payee}
     ...
     * <ul><li>A {@code LibraAccount::SentPaymentEvent} with the {@code payer} field being the Parent VASP's address,</li></ul>
     * and payee field being {@code child_address}. This is emitted on the Parent VASP's
     * {@code LibraAccount::LibraAccount} {@code sent_events} handle.
     * <ul><li>A {@code LibraAccount::ReceivedPaymentEvent} with the  {@code payer} field being the Parent VASP's address,</li></ul>
     * and payee field being {@code child_address}. This is emitted on the new Child VASPS's
     * {@code LibraAccount::LibraAccount} {@code received_events} handle.
     *
     * <p><b>Parameters</b>
     * | Name                    | Type         | Description                                                                                                                                 |
     * | ------                  | ------       | -------------                                                                                                                               |
    ...
    public static final class CreateChildVaspAccount extends ScriptCall {
        ...
        public CreateChildVaspAccount(TypeTag coin_type, AccountAddress child_address, com.novi.serde.Bytes auth_key_prefix, Boolean add_all_currencies, @com.novi.serde.Unsigned Long child_initial_balance) {
            java.util.Objects.requireNonNull(coin_type, "coin_type must not be null");
    ...
    public static final class CreateDesignatedDealer extends ScriptCall {
        ...
        public CreateDesignatedDealer(TypeTag currency, @com.novi.serde.Unsigned Long sliding_nonce, AccountAddress addr, com.novi.serde.Bytes auth_key_prefix, com.novi.serde.Bytes human_name, Boolean add_all_currencies) {
            java.util.Objects.requireNonNull(currency, "currency must not be null");
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
    ...
    public static final class CreateParentVaspAccount extends ScriptCall {
        ...
        public CreateParentVaspAccount(TypeTag coin_type, @com.novi.serde.Unsigned Long sliding_nonce, AccountAddress new_account_address, com.novi.serde.Bytes auth_key_prefix, com.novi.serde.Bytes human_name, Boolean add_all_currencies) {
            java.util.Objects.requireNonNull(coin_type, "coin_type must not be null");
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
     ...
     * extracts the {@code LibraAccount::KeyRotationCapability} for {@code account} and adds
     ...
     * | Error Category              | Error Reason                                               | Description                                                                                   |
     * | ----------------            | --------------                                             | -------------                                                                                 |
     * | {@code Errors::INVALID_STATE}     | {@code LibraAccount::EKEY_ROTATION_CAPABILITY_ALREADY_EXTRACTED} | {@code account} has already delegated/extracted its {@code LibraAccount::KeyRotationCapability}.          |
    ...
    public static final class CreateValidatorAccount extends ScriptCall {
        ...
        public CreateValidatorAccount(@com.novi.serde.Unsigned Long sliding_nonce, AccountAddress new_account_address, com.novi.serde.Bytes auth_key_prefix, com.novi.serde.Bytes human_name) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
            java.util.Objects.requireNonNull(new_account_address, "new_account_address must not be null");
            java.util.Objects.requireNonNull(auth_key_prefix, "auth_key_prefix must not be null");
            java.util.Objects.requireNonNull(human_name, "human_name must not be null");
    ...
    public static final class CreateValidatorOperatorAccount extends ScriptCall {
        ...
        public CreateValidatorOperatorAccount(@com.novi.serde.Unsigned Long sliding_nonce, AccountAddress new_account_address, com.novi.serde.Bytes auth_key_prefix, com.novi.serde.Bytes human_name) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
            java.util.Objects.requireNonNull(new_account_address, "new_account_address must not be null");
            java.util.Objects.requireNonNull(auth_key_prefix, "auth_key_prefix must not be null");
            java.util.Objects.requireNonNull(human_name, "human_name must not be null");
     ...
     * not be either {@code 0xA550C18} (the Libra Root address), or {@code 0xB1E55ED} (the
     ...
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Scripts::unfreeze_account}</li></ul>
     */
    public static final class FreezeAccount extends ScriptCall {
        public final @com.novi.serde.Unsigned Long sliding_nonce;
        public final AccountAddress to_freeze_account;

        public FreezeAccount(@com.novi.serde.Unsigned Long sliding_nonce, AccountAddress to_freeze_account) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
     ...
     * {@code DualAttestation::get_cur_microlibra_limit} LBR and {@code payer} and {@code payee} are distinct VASPs.
     ...
     * Standardized {@code metadata} LCS format can be found in {@code libra_types::transaction::metadata::Metadata}.
     *
     * <p><b>Events</b>
     * Successful execution of this script emits two events:
     * <ul><li>A {@code LibraAccount::SentPaymentEvent} on {@code payer}'s {@code LibraAccount::LibraAccount} {@code sent_events} handle; and</li></ul>
     * <ul><li>A {@code LibraAccount::ReceivedPaymentEvent} on {@code payee}'s {@code LibraAccount::LibraAccount} {@code received_events} handle.</li></ul>
     *
     * <p><b>Parameters</b>
     * | Name                 | Type         | Description                                                                                                                  |
     * | ------               | ------       | -------------                                                                                                                |
     ...
     * | Error Category             | Error Reason                                     | Description                                                                                                                         |
     * | ----------------           | --------------                                   | -------------                                                                                                                       |
     * | {@code Errors::NOT_PUBLISHED}    | {@code LibraAccount::EPAYER_DOESNT_HOLD_CURRENCY}      | {@code payer} doesn't hold a balance in {@code Currency}.                                                                                       |
     * | {@code Errors::LIMIT_EXCEEDED}   | {@code LibraAccount::EINSUFFICIENT_BALANCE}            | {@code amount} is greater than {@code payer}'s balance in {@code Currency}.                                                                           |
     * | {@code Errors::INVALID_ARGUMENT} | {@code LibraAccount::ECOIN_DEPOSIT_IS_ZERO}            | {@code amount} is zero.                                                                                                                   |
     * | {@code Errors::NOT_PUBLISHED}    | {@code LibraAccount::EPAYEE_DOES_NOT_EXIST}            | No account exists at the {@code payee} address.                                                                                           |
     * | {@code Errors::INVALID_ARGUMENT} | {@code LibraAccount::EPAYEE_CANT_ACCEPT_CURRENCY_TYPE} | An account exists at {@code payee}, but it does not accept payments in {@code Currency}.                                                        |
     ...
     * | {@code Errors::LIMIT_EXCEEDED}   | {@code LibraAccount::EWITHDRAWAL_EXCEEDS_LIMITS}       | {@code payer} has exceeded its daily withdrawal limits for the backing coins of LBR.                                                      |
     * | {@code Errors::LIMIT_EXCEEDED}   | {@code LibraAccount::EDEPOSIT_EXCEEDS_LIMITS}          | {@code payee} has exceeded its daily deposit limits for LBR.                                                                              |
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Script::create_child_vasp_account}</li></ul>
     * <ul><li>{@code Script::create_parent_vasp_account}</li></ul>
    ...
    public static final class PeerToPeerWithMetadata extends ScriptCall {
        ...
        public PeerToPeerWithMetadata(TypeTag currency, AccountAddress payee, @com.novi.serde.Unsigned Long amount, com.novi.serde.Bytes metadata, com.novi.serde.Bytes metadata_signature) {
            java.util.Objects.requireNonNull(currency, "currency must not be null");
     ...
     * {@code LibraAccount::Balance<Token>} to the {@code Libra::Preburn<Token>} published under the same
     ...
     * <p><b>Events</b>
     * Successful execution of this script emits two events:
     * <ul><li>{@code LibraAccount::SentPaymentEvent } on {@code account}'s {@code LibraAccount::LibraAccount} {@code sent_events}</li></ul>
     * handle with the {@code payee} and {@code payer} fields being {@code account}'s address; and
     * <ul><li>A {@code Libra::PreburnEvent} with {@code Token}'s currency code on the</li></ul>
     * {@code Libra::CurrencyInfo<Token}'s {@code preburn_events} handle for {@code Token} and with
     ...
     * | Error Category           | Error Reason                                             | Description                                                                             |
     * | ----------------         | --------------                                           | -------------                                                                           |
     * | {@code Errors::NOT_PUBLISHED}  | {@code Libra::ECURRENCY_INFO}                                  | The {@code Token} is not a registered currency on-chain.                                      |
     * | {@code Errors::INVALID_STATE}  | {@code LibraAccount::EWITHDRAWAL_CAPABILITY_ALREADY_EXTRACTED} | The withdrawal capability for {@code account} has already been extracted.                     |
     * | {@code Errors::LIMIT_EXCEEDED} | {@code LibraAccount::EINSUFFICIENT_BALANCE}                    | {@code amount} is greater than {@code payer}'s balance in {@code Token}.                                  |
     * | {@code Errors::NOT_PUBLISHED}  | {@code LibraAccount::EPAYER_DOESNT_HOLD_CURRENCY}              | {@code account} doesn't hold a balance in {@code Token}.                                            |
     * | {@code Errors::NOT_PUBLISHED}  | {@code Libra::EPREBURN}                                        | {@code account} doesn't have a {@code Libra::Preburn<Token>} resource published under it.           |
     * | {@code Errors::INVALID_STATE}  | {@code Libra::EPREBURN_OCCUPIED}                               | The {@code value} field in the {@code Libra::Preburn<Token>} resource under the sender is non-zero. |
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Script::cancel_burn}</li></ul>
     * <ul><li>{@code Script::burn}</li></ul>
    ...
    public static final class Preburn extends ScriptCall {
        ...
        public Preburn(TypeTag token, @com.novi.serde.Unsigned Long amount) {
            java.util.Objects.requireNonNull(token, "token must not be null");
            java.util.Objects.requireNonNull(amount, "amount must not be null");
            this.token = token;
            this.amount = amount;
     ...
     * containing the 32-byte ed25519 {@code public_key} and the {@code LibraAccount::KeyRotationCapability} for
     ...
     * | Error Category              | Error Reason                                               | Description                                                                                         |
     * | ----------------            | --------------                                             | -------------                                                                                       |
     * | {@code Errors::INVALID_STATE}     | {@code LibraAccount::EKEY_ROTATION_CAPABILITY_ALREADY_EXTRACTED} | {@code account} has already delegated/extracted its {@code LibraAccount::KeyRotationCapability} resource.       |
     ...
     * config resource held under {@code validator_account}. It does not emit a {@code LibraConfig::NewEpochEvent}
    ...
    public static final class RegisterValidatorConfig extends ScriptCall {
        ...
        public RegisterValidatorConfig(AccountAddress validator_account, com.novi.serde.Bytes consensus_pubkey, com.novi.serde.Bytes validator_network_addresses, com.novi.serde.Bytes fullnode_network_addresses) {
     ...
     * emits a {@code LibraConfig::NewEpochEvent} event. Once the reconfiguration triggered by this event
    ...
    public static final class RemoveValidatorAndReconfigure extends ScriptCall {
        ...
        public RemoveValidatorAndReconfigure(@com.novi.serde.Unsigned Long sliding_nonce, com.novi.serde.Bytes validator_name, AccountAddress validator_address) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
            java.util.Objects.requireNonNull(validator_name, "validator_name must not be null");
            java.util.Objects.requireNonNull(validator_address, "validator_address must not be null");
            this.sliding_nonce = sliding_nonce;
     ...
     *
     * <p><b>Technical Description</b>
     * Rotate the {@code account}'s {@code LibraAccount::LibraAccount} {@code authentication_key} field to {@code new_key}.
     * {@code new_key} must be a valid ed25519 public key, and {@code account} must not have previously delegated
     * its {@code LibraAccount::KeyRotationCapability}.
     *
     * <p><b>Parameters</b>
     * | Name      | Type         | Description                                                 |
     * | ------    | ------       | -------------                                               |
     ...
     * | ----------------           | --------------                                             | -------------                                                                            |
     * | {@code Errors::INVALID_STATE}    | {@code LibraAccount::EKEY_ROTATION_CAPABILITY_ALREADY_EXTRACTED} | {@code account} has already delegated/extracted its {@code LibraAccount::KeyRotationCapability}.     |
     * | {@code Errors::INVALID_ARGUMENT} | {@code LibraAccount::EMALFORMED_AUTHENTICATION_KEY}              | {@code new_key} was an invalid length.                                                         |
     *
     * <p><b>Related Scripts</b>
     ...
     *
     * <p><b>Technical Description</b>
     * Rotates the {@code account}'s {@code LibraAccount::LibraAccount} {@code authentication_key} field to {@code new_key}.
     * {@code new_key} must be a valid ed25519 public key, and {@code account} must not have previously delegated
     * its {@code LibraAccount::KeyRotationCapability}.
     *
     * <p><b>Parameters</b>
     ...
     * | Name            | Type         | Description                                                                                                  |
     * | ------          | ------       | -------------                                                                                                |
     * | {@code lr_account}    | {@code &signer}    | The signer reference of the sending account of the write set transaction. May only be the Libra Root signer. |
     * | {@code account}       | {@code &signer}    | Signer reference of account specified in the {@code execute_as} field of the write set transaction.                |
     * | {@code sliding_nonce} | {@code u64}        | The {@code sliding_nonce} (see: {@code SlidingNonce}) to be used for this transaction for Libra Root.                    |
     * | {@code new_key}       | {@code vector<u8>} | New ed25519 public key to be used for {@code account}.                                                             |
     *
     * <p><b>Common Abort Conditions</b>
     * | Error Category             | Error Reason                                               | Description                                                                                                |
     ...
     * {@code LibraAccount::KeyRotationCapability} stored in the {@code RecoveryAddress::RecoveryAddress} resource
     ...
     * that contains {@code to_recover}'s {@code LibraAccount::KeyRotationCapability}.
     *
     * <p><b>Parameters</b>
     * | Name               | Type         | Description                                                                                                                    |
     * | ------             | ------       | -------------                                                                                                                  |
     * | {@code account}          | {@code &signer}    | Signer reference of the sending account of the transaction.                                                                    |
     * | {@code recovery_address} | {@code address}    | Address where {@code RecoveryAddress::RecoveryAddress} that holds {@code to_recover}'s {@code LibraAccount::KeyRotationCapability} is published. |
     ...
     * | {@code Errors::INVALID_ARGUMENT} | {@code RecoveryAddress::EACCOUNT_NOT_RECOVERABLE}   | {@code to_recover}'s {@code LibraAccount::KeyRotationCapability}  is not in the {@code RecoveryAddress::RecoveryAddress}  resource published under {@code recovery_address}. |
     * | {@code Errors::INVALID_ARGUMENT} | {@code LibraAccount::EMALFORMED_AUTHENTICATION_KEY} | {@code new_key} was an invalid length.                                                                                                                     |
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Script::rotate_authentication_key}</li></ul>
    ...
    public static final class RotateAuthenticationKeyWithRecoveryAddress extends ScriptCall {
        ...
        public RotateAuthenticationKeyWithRecoveryAddress(AccountAddress recovery_address, AccountAddress to_recover, com.novi.serde.Bytes new_key) {
            java.util.Objects.requireNonNull(recovery_address, "recovery_address must not be null");
     ...
     * <p><b>Technical Description</b>
     * This updates the fields with corresponding names held in the {@code ValidatorConfig::ValidatorConfig}
     * config resource held under {@code validator_account}. It then emits a {@code LibraConfig::NewEpochEvent} to
    ...
    public static final class SetValidatorConfigAndReconfigure extends ScriptCall {
        ...
        public SetValidatorConfigAndReconfigure(AccountAddress validator_account, com.novi.serde.Bytes consensus_pubkey, com.novi.serde.Bytes validator_network_addresses, com.novi.serde.Bytes fullnode_network_addresses) {
            java.util.Objects.requireNonNull(validator_account, "validator_account must not be null");
            java.util.Objects.requireNonNull(consensus_pubkey, "consensus_pubkey must not be null");
            java.util.Objects.requireNonNull(validator_network_addresses, "validator_network_addresses must not be null");
            java.util.Objects.requireNonNull(fullnode_network_addresses, "fullnode_network_addresses must not be null");
     ...
     * {@code LibraConfig::NewEpochEvent} and no reconfiguration of the system is initiated by this script.
     *
     * <p><b>Parameters</b>
     * | Name               | Type         | Description                                                                                  |
     * | ------             | ------       | -------------                                                                                |
    ...
    public static final class SetValidatorOperator extends ScriptCall {
        ...
        public SetValidatorOperator(com.novi.serde.Bytes operator_name, AccountAddress operator_account) {
    ...
    public static final class SetValidatorOperatorWithNonceAdmin extends ScriptCall {
        ...
        public SetValidatorOperatorWithNonceAdmin(@com.novi.serde.Unsigned Long sliding_nonce, com.novi.serde.Bytes operator_name, AccountAddress operator_account) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
            java.util.Objects.requireNonNull(operator_name, "operator_name must not be null");
            java.util.Objects.requireNonNull(operator_account, "operator_account must not be null");
            this.sliding_nonce = sliding_nonce;
     ...
     * <ul><li>A {@code Libra::MintEvent} with the amount and currency code minted is emitted on the</li></ul>
     * {@code mint_event_handle} in the stored {@code Libra::CurrencyInfo<CoinType>} resource stored under
     * {@code 0xA550C18}; and
    ...
    public static final class TieredMint extends ScriptCall {
        ...
        public TieredMint(TypeTag coin_type, @com.novi.serde.Unsigned Long sliding_nonce, AccountAddress designated_dealer_address, @com.novi.serde.Unsigned Long mint_amount, @com.novi.serde.Unsigned Long tier_index) {
            java.util.Objects.requireNonNull(coin_type, "coin_type must not be null");
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
     ...
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Scripts::freeze_account}</li></ul>
     */
    public static final class UnfreezeAccount extends ScriptCall {
        public final @com.novi.serde.Unsigned Long sliding_nonce;
        public final AccountAddress to_unfreeze_account;

        public UnfreezeAccount(@com.novi.serde.Unsigned Long sliding_nonce, AccountAddress to_unfreeze_account) {
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
     ...
     *
     * <p><b>Technical Description</b>
     * Updates the {@code micro_lbr_limit} field of the {@code DualAttestation::Limit} resource published under
     * {@code 0xA550C18}. The amount is set in micro-LBR.
     *
     * <p><b>Parameters</b>
     * | Name                  | Type      | Description                                                                                               |
     * | ------                | ------    | -------------                                                                                             |
     * | {@code tc_account}          | {@code &signer} | The signer reference of the sending account of this transaction. Must be the Treasury Compliance account. |
     * | {@code sliding_nonce}       | {@code u64}     | The {@code sliding_nonce} (see: {@code SlidingNonce}) to be used for this transaction.                                |
     * | {@code new_micro_lbr_limit} | {@code u64}     | The new dual attestation limit to be used on-chain.                                                       |
     *
     * <p><b>Common Abort Conditions</b>
     * | Error Category             | Error Reason                            | Description                                                                                |
     * | ----------------           | --------------                          | -------------                                                                              |
     ...
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Scripts::update_exchange_rate}</li></ul>
     * <ul><li>{@code Scripts::update_minting_ability}</li></ul>
     */
     ...
     *
     * <p><b>Technical Description</b>
     * Updates the on-chain exchange rate from the given {@code Currency} to micro-LBR.  The exchange rate
     ...
     * | {@code new_exchange_rate_numerator}   | {@code u64}     | The numerator for the new to micro-LBR exchange rate for {@code Currency}.                                                               |
     * | {@code new_exchange_rate_denominator} | {@code u64}     | The denominator for the new to micro-LBR exchange rate for {@code Currency}.                                                             |
     *
     * <p><b>Common Abort Conditions</b>
     * | Error Category             | Error Reason                            | Description                                                                                |
     * | ----------------           | --------------                          | -------------                                                                              |
     ...
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Scripts::update_dual_attestation_limit}</li></ul>
     * <ul><li>{@code Scripts::update_minting_ability}</li></ul>
     */
    public static final class UpdateExchangeRate extends ScriptCall {
        ...
        public UpdateExchangeRate(TypeTag currency, @com.novi.serde.Unsigned Long sliding_nonce, @com.novi.serde.Unsigned Long new_exchange_rate_numerator, @com.novi.serde.Unsigned Long new_exchange_rate_denominator) {
            java.util.Objects.requireNonNull(currency, "currency must not be null");
            java.util.Objects.requireNonNull(sliding_nonce, "sliding_nonce must not be null");
     ...
     *
     * <p><b>Technical Description</b>
     * Updates the {@code LibraVersion} on-chain config and emits a {@code LibraConfig::NewEpochEvent} to trigger
     ...
     * | Name            | Type      | Description                                                                |
     * | ------          | ------    | -------------                                                              |
     * | {@code account}       | {@code &signer} | Signer reference of the sending account. Must be the Libra Root account.   |
     * | {@code sliding_nonce} | {@code u64}     | The {@code sliding_nonce} (see: {@code SlidingNonce}) to be used for this transaction. |
     ...
     * | {@code Errors::INVALID_ARGUMENT} | {@code SlidingNonce::ENONCE_TOO_NEW}                | The {@code sliding_nonce} is too far in the future.                                              |
     * | {@code Errors::INVALID_ARGUMENT} | {@code SlidingNonce::ENONCE_ALREADY_RECORDED}       | The {@code sliding_nonce} has been previously recorded.                                          |
     * | {@code Errors::REQUIRES_ADDRESS} | {@code CoreAddresses::ELIBRA_ROOT}                  | {@code account} is not the Libra Root account.                                                   |
     * | {@code Errors::INVALID_ARGUMENT} | {@code LibraVersion::EINVALID_MAJOR_VERSION_NUMBER} | {@code major} is less-than or equal to the current major version stored on-chain.                |
     */
     ...
     *
     * <p><b>Technical Description</b>
     * This transaction sets the {@code can_mint} field of the {@code Libra::CurrencyInfo<Currency>} resource
     ...
     * | ----------------           | --------------                        | -------------                                        |
     * | {@code Errors::REQUIRES_ADDRESS} | {@code CoreAddresses::ETREASURY_COMPLIANCE} | {@code tc_account} is not the Treasury Compliance account. |
     * | {@code Errors::NOT_PUBLISHED}    | {@code Libra::ECURRENCY_INFO}               | {@code Currency} is not a registered currency on-chain.    |
     *
     * <p><b>Related Scripts</b>
     * <ul><li>{@code Scripts::update_dual_attestation_limit}</li></ul>
     * <ul><li>{@code Scripts::update_exchange_rate}</li></ul>
