...
public final class ChainId {
    ...
    public static ChainId deserialize(com.novi.serde.Deserializer deserializer) throws java.lang.Exception {
        Builder builder = new Builder();
        builder.value = deserializer.deserialize_u8();
        return builder.build();
    }

    public static ChainId lcsDeserialize(byte[] input) throws java.lang.Exception {
