...
final class TraitHelpers {
    ...
    static @com.novi.serde.Unsigned Byte @com.novi.serde.ArrayLen(length=16) [] deserialize_array16_u8_array(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
